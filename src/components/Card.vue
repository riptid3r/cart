<template lang="pug">
    .col-md-4
      .card.mb-4
        img(:src="card.image", alt="image", height="280").w-100.cover.px-3
        .card-body
          .row.align-items-center.justify-content-between.px-2
            ...
            button.btn.btn-outline-success.col-12.col-md-6(@click="$emit('put-in-cart', card)") {{ !card.inCart ? 'Купить' : 'В корзине' }}
</template>
